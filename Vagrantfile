...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", inline: <<-SHELL
     ...
     git clone https://github.com/bertalanvoros/post-api.git /opt/temp
     docker build -t api -f /opt/temp/Dockerfile .
     docker-compose -f /opt/temp/docker-compose.yml up -d
  SHELL
end
